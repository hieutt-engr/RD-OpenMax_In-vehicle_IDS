...
LOGFILE="./save/log/ConResnet50_MPNCOV_NC_Maha_OE_3_Feat_Basic_Freeze_test_ood__${TIMESTAMP}.log"
...
--oe_data_root ./data/set_04/test_03_known_vehicle_unknown_attack/preprocessed/ood/acgan/generated_ood.tfrecord \
--n_classes 6 \
--loss p \
...
--warmup_epoch 40 \
--trial Maha_Freeze_Basic_loss_test \
> "$LOGFILE" 2>&1
